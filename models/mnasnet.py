...
def _stack(in_ch, out_ch, kernel_size, stride, exp_factor, repeats, bn_momentum):
    ...
    for _ in range(1, repeats):
        remaining.append(
            _InvertedResidual(out_ch, out_ch, kernel_size, 1, exp_factor, bn_momentum=bn_momentum)
        )
...
class MNASNet(torch.nn.Module):
    ...
    def __init__(self, alpha, dropout=0.2):
        ...
        self.fc2 = nn.Linear(1280, 3)
        self.fc3 = nn.Linear(1280, 3)
